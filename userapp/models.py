...
class Address(models.Model):
    aname = models.CharField(max_length=30)  #收件人名字
    aphone = models.CharField(max_length=11) #电话
    addr = models.CharField(max_length=100)   #地址
    isdefault = models.BooleanField(default=False)  #是否设置地址为默认地址，这里选择不设置为默认地址，因为可以有很多个地址
